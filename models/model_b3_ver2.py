...
class NeighborFeatureAggregation(nn.Module):
    def __init__(self, in_d):
        ...
        # B3_Ver2-only modules are appended after the complete author path.
        self.pre_diff_c2 = SymmetricPreDiffGate(self.in_d[1])
