...
from models.model_b1 import BaseNet
...
def trainValidateSegmentation(args):
    ...
    config = {
        'purpose': 'B1 top-down residual selective fusion, validation-only screen',
        ...
        'test_used': False,
        'model': 'models/model_b1.py',
        'change': 'top-down residual selective gates only; no pre-diff gate; no SSM'
    }
    ...
    shutil.copy2(Path('/content/Mobile-CDNet/models/model_b1.py'), Path(args.savedir, 'model_b1.py'))
    start_epoch = 0
    cur_iter = 0
    max_F1_val = 0
    best_meta = None
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        print('B1 gate scales:', gate_scales)
